document.addEventListener('DOMContentLoaded', function () {
    ...
    function loadTab(tabName) {
        fetch('api.php?action=get_tab&tab=' + tabName)
            ...
            .catch(function () {
                content.innerHTML = '<p style="color:red;">加载失败喵</p>';
            });
    }
...
function exportRecords() {
    var classId = document.getElementById('filter-class') ? document.getElementById('filter-class').value : '';
    var url = 'api.php?action=export_records';
